...
const JobDetails = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://jobg.onrender.com/api/v1/job/${id}`, {
  ...
  return (
    <section className="flex justify-center mb-[48px]">
      <div className="w-10/12 flex flex-col items-center ">
        <h3 className=" my-10 p-2 font-bold text-3xl  font-serif bg-blue-950 text-slate-50 rounded-md ">Job Details</h3>
        <div className=" shadow-lg shadow-slate-100 rounded-md w-1/2  bg-slate-50 border-2 border-slate-200 m-3 p-3">
          <p className="font-bold flex m-3 p-1">
