...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          "https://jobg.onrender.com/api/v1/job/getmyjobs",
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`https://jobg.onrender.com/api/v1/job/update/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(`https://jobg.onrender.com/api/v1/job/delete/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
                ...
                {myJobs.map((element) => (
                  <div className="my-10 bg-slate-100 border-2 border-slate-400 m-2 p-2 rounded-lg " key={element._id}>
                    <div className="flex w-full  rounded-md">
                      <div className="w-1/4 bg-slate-50 rounded-md">
                        <div>
                      ...
                      <div className="w-1/2 bg-slate-50 rounded-md flex flex-col justify-center">
                    ...
                    <div className="w-1/4 bg-slate-50 rounded-md flex flex-col items-center justify-center">
