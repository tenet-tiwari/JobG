...
import img from '../Auth/logo1.svg'
...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    try {
      const response = await axios.get(
        "https://jobg.onrender.com/api/v1/user/logout",
        {
  ...
  return (
    <nav className="bg-blue-950 flex w-full mb-0 relative text-base sm:text-lg  ">
...
// import React, { useContext, useState } from "react";
// import { Context } from "../../main";
// import { useDarkMode } from "../../../DarkModeContext"; // Adjust the path as needed
// import { Link, useNavigate } from "react-router-dom";
// import axios from "axios";
// import toast from "react-hot-toast";
// import { GiHamburgerMenu } from "react-icons/gi";
// import { MdBrightness4, MdBrightness7 } from "react-icons/md"; // Moon and Sun icons
// import img from '../Auth/logo1.svg'
...
//   return (
//     <nav className={`flex w-full mb-0 relative text-base sm:text-lg ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-blue-950 text-slate-50'}`}>
//       <div className="w-full mx-5 py-1 flex justify-between items-center">
...
//             <li className="font-semibold m-1 p-1 hover:bg-slate-50 hover:text-blue-950 rounded-md border-[1px]">
//               <Link to={"/"}>HOME</Link>
//             </li>
//             <li className="font-semibold m-1 p-1 hover:bg-slate-50 hover:text-blue-950 rounded-md border-[1px]">
//               <Link to={"/job/getall"}>ALL JOBS</Link>
...
//       </div>
//       {show && (
//         <div className={`absolute top-full flex rounded-md right-0 bg-white z-50 lg:hidden ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'}`}>
//           <ul className="flex flex-col w-full items-center space-y-3 mt-3 p-3">
//             <li className="font-semibold m-1 p-1 hover:bg-slate-50 hover:text-blue-950 rounded-md border-[1px]">
//               <Link to={"/"} onClick={() => setShow(false)}>
//                 HOME
//               </Link>
