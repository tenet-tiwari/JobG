  ...
  return (
    <>
      ...
      <h3 className="text-center font-bold text-3xl mb-4 border-b-2 border-b-blue-950">How JobPortal Works</h3>
        <div className=" flex flex-col items-center bg-blue-200 w-10/12 m-1 p-4 rounded-2xl">
...
//   return (
//     <div className={`justify-center items-center hidden md:flex md:flex-col m-3 p-3 ${isDarkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
//       <h3 className={`text-center font-bold text-3xl mb-4 border-b-2 ${isDarkMode ? 'border-blue-300' : 'border-blue-950'}`}>
//         How JobPortal Works
//       </h3>
//       <div className={`flex flex-col items-center w-10/12 m-1 p-4 rounded-2xl ${isDarkMode ? 'bg-gray-800' : 'bg-blue-200'}`}>
//         <div className="flex m-5 p-3">
//           <div className={`flex flex-col justify-center items-center mx-5 shadow-md ${isDarkMode ? 'shadow-gray-700 bg-black text-white' : 'shadow-blue-500 bg-white text-black'} border-2 ${isDarkMode ? 'border-gray-700' : 'border-slate-500'} rounded-xl p-1 m-3`}>
//             <div className={`m-3 p-3 flex justify-center items-center scale-105 w-auto ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-white text-gray-800'} shadow-md ${isDarkMode ? 'shadow-gray-600' : 'shadow-blue-500'} border-2 rounded-full hover:scale-110`}>
//               <FaUserPlus />
//             </div>
//             <p className={`font-bold m-1 p-1 text-center border-b-[1px] ${isDarkMode ? 'border-blue-300' : 'border-blue-950'}`}>
//               Create Account
//             </p>
//             <p className="w-full font-semibold text-center items-center m-2">
//               Sign up quickly to access personalized content, connect with the community, and enhance your user experience. Join us today!
